...
namespace WBIResources
{
    ...
    public class WBIResourceSwitcher : WBIInflatablePartModule, IPartCostModifier, IPartMassModifier
    {
        ...
        public ConfigNode CurrentTemplate
        {
            get
            {
                if (CurrentTemplateIndex < 0 || CurrentTemplateIndex > templateManager.templateNodes.Length || templateManager.templateNodes.Count() <= 0)
        ...
        public override void OnStart(PartModule.StartState state)
        {
            ...
            Fields["partMass"].guiActive = WBIResourcesSettings.EnableDebugLogging;
            Fields["currentMass"].guiActive = WBIResourcesSettings.EnableDebugLogging;
        }
        ...
        public void initTemplates()
        {
            ...
            if (CurrentTemplateIndex == -1 && templateManager.templateNodes.Count() > 0)
            {
